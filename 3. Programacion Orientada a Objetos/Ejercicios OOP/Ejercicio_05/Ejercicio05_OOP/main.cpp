...
using namespace std;
/*
Crea una clase llamada Termometro que represente un termómetro
...
de la actual, convierte la temperatura a la nueva unidad.
    - Fórmula de conversión de Celsius a Fahrenheit: (C * 9/5)
+ 32
    - Fórmula de conversión de Fahrenheit a Celsius: (F - 32)
* 5/9
