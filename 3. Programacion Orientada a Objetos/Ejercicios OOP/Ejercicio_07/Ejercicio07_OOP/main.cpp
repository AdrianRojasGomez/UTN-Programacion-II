...
/*
    ...
    2. Solicitar al usuario que ingrese su nombre y contraseña al iniciar el
    programa.
    3. Verificar si las credenciales ingresadas coinciden con alguno de
    los usuarios cargados en el sistema utilizando una función que
    reciba el array de usuarios, la cantidad de usuarios, el nombre y la
    contraseña. Esta función debe devolver el índice donde se
    ...
    saludo amigable. Utiliza una función que reciba un objeto Usuario
    y muestre el saludo con el rol específico.
    5. Si el usuario ingresa credenciales incorrectas, permitir un máximo
